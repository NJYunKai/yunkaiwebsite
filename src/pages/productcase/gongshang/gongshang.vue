<template>
  <div class="r-news">
    <div class="r-news-content">
      ...
      <div style="display:block;font-family:Microsoft YaHei;font-size:30px;color:#000000;font-weight:bold;text-decoration:none;margin: 10px 0 30px 370px">
          浙江工商大学
      </div>
      ...
      <div style="display:block;font-family:Microsoft YaHei;font-size:16px;color:#5A5A5A;font-weight:normal;text-decoration:none;">
		<div setsid="article250">
            ...
            <p style="margin-left:40px">&nbsp; &nbsp;物联网实践与智能体验实验室</p><br> &nbsp;<br>
