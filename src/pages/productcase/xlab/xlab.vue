    ...
    <div class="r-news-content">
      ...
      <div style="display:block;font-family:Microsoft YaHei;font-size:16px;color:#5A5A5A;font-weight:normal;text-decoration:none;">
        ...
        <div style="display:block;font-family:Microsoft YaHei;font-size:16px;color:#5A5A5A;font-weight:normal;text-decoration:none;">
            ...
            <img src="../../img/xlab-3.jpg" width="400px" height="200px" alt="" style="margin-left:50px">
            <img src="../../img/xlab-1.jpg" width="400px" height="200px" alt="" style="margin-left:40px">
        </div><br> &nbsp;<br> 
        ...
        <div style="display:block;font-family:Microsoft YaHei;font-size:16px;color:#5A5A5A;font-weight:normal;text-decoration:none;">
            ...
            <img src="../../img/xlab-4.jpg" width="400px" height="200px" alt="" style="margin-left:300px">
        </div><br> &nbsp;<br> 
        ...
        <div style="display:block;font-family:Microsoft YaHei;font-size:16px;color:#5A5A5A;font-weight:normal;text-decoration:none;">
            ...
            <img src="../../img/xlab-5.jpg" width="300px" height="380px" alt="" style="margin-left:320px">
        </div><br> &nbsp;<br> 
